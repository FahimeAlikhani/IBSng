...
namespace NeginIBSng.Controllers.charge
{
    ...
    [ApiController]
    public class GetAdminPermValControllers : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetAdminPermValControllers(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetAdminPermValInputModel> model)
        {
            var result = new ApiModol<GetAdminPermValOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetAdminPermValOutputModel>(stringJson);
