...
namespace NeginIBSng.Controllers.charge
{
    ...
    [ApiController]
    public class CanDoConroller : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public CanDoConroller(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<CanDoInputModel> model)
        {
            var result = new ApiModol<CanDoOutputModel>();
