...
namespace NeginIBSng.Controllers.isp
{
    ...
    [ApiController]
    public class ResetISPPageStyleController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public ResetISPPageStyleController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<ResetISPPageStyleInputModel> model)
        {
            var result = new ApiModol<ResetISPPageStyleOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<ResetISPPageStyleOutputModel>(stringJson);
