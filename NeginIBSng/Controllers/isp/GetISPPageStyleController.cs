...
namespace NeginIBSng.Controllers.isp
{
    ...
    [ApiController]
    public class GetISPPageStyleController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetISPPageStyleController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetISPPageStyleInputModel> model)
        {
            var result = new ApiModol<GetISPPageStyleOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetISPPageStyleOutputModel>(stringJson);
