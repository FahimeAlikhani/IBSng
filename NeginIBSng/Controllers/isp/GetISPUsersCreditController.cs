...
namespace NeginIBSng.Controllers.isp
    {
        ...
        [ApiController]
        public class GetISPUsersCreditController : ControllerBase
        {
            private readonly IConfiguration _configuration;
            public GetISPUsersCreditController(IConfiguration configuration)
            {
                _configuration = configuration;
            }
            public async Task<IActionResult> Post(SendModel<GetISPUsersCreditInputModel> model)
            {
                var result = new ApiModol<GetISPUsersCreditOutputModel>();
                ...
                var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetISPUsersCreditOutputModel>(stringJson);
