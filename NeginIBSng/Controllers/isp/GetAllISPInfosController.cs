...
namespace NeginIBSng.Controllers.isp
{
    ...
    [ApiController]
    public class GetAllISPInfosController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetAllISPInfosController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetAllISPInfosInputModel> model)
        {
            var result = new ApiModol<GetAllISPInfosOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetAllISPInfosOutputModel>(stringJson);
