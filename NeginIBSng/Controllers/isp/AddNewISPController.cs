...
namespace NeginIBSng.Controllers.isp
{
    ...
    [ApiController]
    public class AddNewISPController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public AddNewISPController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<AddNewISPInputModel> model)
        {
            var result = new ApiModol<AddNewISPOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<AddNewISPOutputModel>(stringJson);
