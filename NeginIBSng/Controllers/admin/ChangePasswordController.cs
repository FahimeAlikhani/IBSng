...
namespace NeginIBSng.Controllers.admin
{
    ...
    public class ChangePasswordController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post(SendModel<ChangePasswordInputModel> model)
        {
            var result = new ApiModol<ChangePasswordoutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<ChangePasswordoutputModel>(stringJson);
