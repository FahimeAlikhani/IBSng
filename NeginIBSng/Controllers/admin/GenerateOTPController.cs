...
namespace NeginIBSng.Controllers.admin
{
    ...
    public class GenerateOTPController : ControllerBase
    {
        ...
        public GenerateOTPController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GenerateOTPInputModel> model)
        {
            var result = new ApiModol<GenerateOTPoutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GenerateOTPoutputModel>(stringJson);
