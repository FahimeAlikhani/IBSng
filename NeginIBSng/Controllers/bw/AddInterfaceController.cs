...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class AddInterfaceController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public AddInterfaceController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<AddInterfaceInputModell> model)
        {
            var result = new ApiModol<AddInterfaceOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<AddInterfaceOutputModel>(stringJson);
