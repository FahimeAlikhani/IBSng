...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class UpdateBwStaticIPContrpller : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public UpdateBwStaticIPContrpller(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Post(SendModel<UpdateBwStaticIPInputModel> model)
        {
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<UpdateBwStaticIPOutputModel>(stringJson);
