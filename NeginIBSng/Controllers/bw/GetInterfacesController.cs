...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class GetInterfacesController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetInterfacesController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetInterfacesInputModel> model)
        {
            var result = new ApiModol<GetInterfacesOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetInterfacesOutputModel>(stringJson);
