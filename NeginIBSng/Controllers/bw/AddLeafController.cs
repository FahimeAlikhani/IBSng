...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class AddLeafController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public AddLeafController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetExtraChargeProfileNamesInputModel> model)
        {
            var result = new ApiModol<Extra_ChargeOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<Extra_ChargeOutputModel>(stringJson);
