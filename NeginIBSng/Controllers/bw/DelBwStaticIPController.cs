...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class DelBwStaticIPController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public DelBwStaticIPController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<DelBwStaticIPInputModel> model)
        {
            var result = new ApiModol<DelBwStaticIPOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<DelBwStaticIPOutputModel>(stringJson);
