...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class AddBwStaticIPController : ControllerBase
    {

        private readonly IConfiguration _configuration;
        public AddBwStaticIPController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<AddBwStaticIPInputModel> model)
        {
            var result = new ApiModol<AddBwStaticIPOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<AddBwStaticIPOutputModel>(stringJson);
