...
namespace NeginIBSng.Controllers.bw
{
    ...
    public class UpdateNodeController : ControllerBase
    {
        ...
        public UpdateNodeController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<UpdateNodeInputModel> model)
        {
            var result = new ApiModol<UpdateNodeOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<UpdateNodeOutputModel>(stringJson);
