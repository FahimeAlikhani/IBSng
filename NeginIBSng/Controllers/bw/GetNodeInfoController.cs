...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class GetNodeInfoController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetNodeInfoController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetNodeInfoInputModel> model)
        {
            var result = new ApiModol<GetNodeInfoOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetNodeInfoOutputModel>(stringJson);
