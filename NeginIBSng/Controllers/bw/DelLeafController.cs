...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class DelLeafController : ControllerBase
    {

        private readonly IConfiguration _configuration;
        public DelLeafController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<DelLeafInputModel> model)
        {
            var result = new ApiModol<DelLeafOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<DelLeafOutputModel>(stringJson);
