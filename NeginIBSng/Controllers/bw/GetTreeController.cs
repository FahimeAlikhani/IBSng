...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class GetTreeController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetTreeController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetTreeInputModel> model)
        {
            var result = new ApiModol<GetTreeOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetTreeOutputModel>(stringJson);
