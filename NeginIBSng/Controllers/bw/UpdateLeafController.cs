...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class UpdateLeafController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public UpdateLeafController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<UpdateLeafInputModel> model)
        {
            var result = new ApiModol<UpdateLeafOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<UpdateLeafOutputModel>(stringJson);
