...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class DelLeafServiceController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public DelLeafServiceController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<DelLeafServiceInputModel> model)
        {
            var result = new ApiModol<DelLeafServiceOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<DelLeafServiceOutputModel>(stringJson);
