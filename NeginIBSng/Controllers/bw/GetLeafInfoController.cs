...
namespace NeginIBSng.Controllers.bw
{
    ...
    [ApiController]
    public class GetLeafInfoController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetLeafInfoController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetLeafInfoInputModel> model)
        {
            var result = new ApiModol<GetLeafInfoOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetLeafInfoOutputModel>(stringJson);
