...
namespace NeginIBSng.Controllers.extra_charge
{
    ...
    [ApiController]
    public class AddExtraChargeProfileController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public AddExtraChargeProfileController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<AddExtraChargeProfileInputModel> model)
        {
            var result = new ApiModol<AddExtraChargeProfileOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<AddExtraChargeProfileOutputModel>(stringJson);
