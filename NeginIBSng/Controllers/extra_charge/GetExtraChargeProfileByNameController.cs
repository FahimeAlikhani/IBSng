...
namespace NeginIBSng.Controllers.extra_charge
{
    ...
    [ApiController]
    public class GetExtraChargeProfileByNameController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetExtraChargeProfileByNameController(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Post(SendModel<GetExtraChargeProfileByNameInputModel> model)
        {
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetExtraChargeProfileByNameOutputModel>(stringJson);
