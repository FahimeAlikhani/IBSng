...
namespace NeginIBSng.Controllers.extra_charge
{
    ...
    [ApiController]
    public class GetExtraChargeProfilesController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public GetExtraChargeProfilesController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public async Task<IActionResult> Post(SendModel<GetExtraChargeProfilesInputModel> model)
        {
            var result = new ApiModol<GetExtraChargeProfilesOutputModel>();
            ...
            var replyModel = Newtonsoft.Json.JsonConvert.DeserializeObject<GetExtraChargeProfilesOutputModel>(stringJson);
